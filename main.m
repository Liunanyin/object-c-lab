...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        while(true){
            ...
            NSInteger number = [inputHandler getUserInputWithLength:25 widthPrompt:menu];
            ...
            if([option isEqualToString:@"quit"]){
                ...
                contact *newContact = [[contact alloc]initWithname:name andemail:email andid:id andnumber:isnumber];
